...
public class Utils {
    ...
    public static String getZMQBindAddress(){
        String discoverable = System.getenv("DISCOVERABLE_PUBLISHERS");
        if (discoverable != null && discoverable.equals("1")) {
            return "*";
        }
        return getZMQAddress();
    }
    ...
    public static String getBindSocketPath(String endpoint){
        return getZMQProtocol() + getZMQBindAddress() + ":" + endpoint;
    }
