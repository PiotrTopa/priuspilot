...
export DISCOVERABLE_PUBLISHERS="1" # if enabled, other devices on same network can access sub/pub data.
#export DEVICE_ADDR="127.0.0.1" # connect to external device running flowpilot over same network. useful for livestreaming.

#export SIMULATION="1"  # uncomment for desktop simulation only
export FINGERPRINT="TOYOTA PRIUS GEN2 2004"  # PriusPilot: skip auto-detection
