...
void usb_init(void) {
  ...
  // power up the PHY
#ifdef PYBOARD
  // STM32F405: Use NOVBUSSENS (bit 21) to disable VBUS sensing.
  // F405 does not have BVALOVAL/BVALOEN in GOTGCTL (those are F413-specific).
  #define USB_OTG_GCCFG_NOVBUSSENS_F405 (1U << 21)
  USBx->GCCFG = USB_OTG_GCCFG_PWRDWN | USB_OTG_GCCFG_NOVBUSSENS_F405;
