...
#ifdef PYBOARD
  // 12MHz crystal (Pyboard v1.1)
  // PLLM: 6 (12MHz / 6 = 2MHz VCO input)
  // PLLN: 96 (2MHz * 96 = 192MHz VCO output)
  // PLLP: 2 (192MHz / 2 = 96MHz system clock)
  // PLLQ: 4 (192MHz / 4 = 48MHz USB clock)
  register_set(&(RCC->PLLCFGR), RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_1 | RCC_PLLCFGR_PLLN_6 | RCC_PLLCFGR_PLLN_5 | RCC_PLLCFGR_PLLSRC_HSE, 0x7F437FFFU);
#else
  // 16mhz crystal
