  ...
  #ifdef PYBOARD
    // STM32F405RG on Pyboard v1.1
    #define MCU_IDCODE 0x413U
  #else
    // STM32F413 on comma.ai panda
...
#ifdef PYBOARD
  #define NUM_INTERRUPTS 82U               // STM32F405 has 82 external interrupt sources
#else
  #define NUM_INTERRUPTS 102U              // STM32F413 has 102 external interrupt sources
#endif
